...
public class MovieFragment extends Fragment {
    ...
    @Override
    public void onViewCreated(@NonNull View mView, @Nullable Bundle savedInstanceState) { super.onViewCreated(mView, savedInstanceState);
    ...
    private void dummyData(List<MovieModel> listMovieModel) {
        ...
        listMovieModel.add(new MovieModel("Toy Story4",R.drawable.toystory,"Animation","77","Woody has always been confident about his place in the world and that his priority is taking care of his kid, whether that's Andy or Bonnie. But when Bonnie adds a reluctant new toy called Forky to her room, a road trip adventure alongside old and new friends will show Woody how big the world can be for a toy.\n"));
        listMovieModel.add(new MovieModel("Avengers: Endgame",R.drawable.avengger,"Animation","84","After the devastating events of Avengers: Infinity War, the universe is in ruins due to the efforts of the Mad Titan, Thanos. With the help of remaining allies, the Avengers must assemble once more in order to undo Thanos' actions and restore order to the universe once and for all, no matter what consequences may be in store.\n"));
        ...
        listMovieModel.add(new MovieModel("Men in Black: Internationa",R.drawable.mib,"Action","60","The Men in Black have always protected the Earth from the scum of the universe. In this new adventure, they tackle their biggest, most global threat to date: a mole in the Men in Black organization.\n"));
        ...
        listMovieModel.add(new MovieModel("Stuber",R.drawable.struber,"Action","64","After crashing his car, a cop who's recovering from eye surgery recruits an Uber driver to help him catch a heroin dealer. The mismatched pair soon find themselves in for a wild day of stakeouts and shootouts as they encounter the city's seedy side.\n"));
        listMovieModel.add(new MovieModel("Anna",R.drawable.anna,"Action","60","Beneath Anna Poliatova's striking beauty lies a secret that will unleash her indelible assassins.\n"));
    }
}
